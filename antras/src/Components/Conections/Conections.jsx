...
function Conections() {
  ...
  return (
    ...
    <section className='container m-auto p-32 max-sm:p-8 animate-fade-up animate-duration-1500 animate-ease-in'>
        <h1 className='text-4xl text-center mb-16 text-orange-300'>Santikių suderinimas</h1>

        <p className='p-5  text-2xl text-justify text-white '>
        ...
        <p className='p-5  text-2xl text-justify text-white mb-14'>
